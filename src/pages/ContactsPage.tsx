...
export default function ContactsPage() {
    ...
    return (
        <>
            ...
            <section className="max-w-[1400px] w-[95%] mx-auto mt-16 py-16">
                ...
                {/* Карта */}
                <div className="mt-12 w-full h-[400px] md:h-[500px] rounded-2xl overflow-hidden border border-gray-300">
                    <iframe
