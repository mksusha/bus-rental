...
export default function FleetPage() {
    ...
    return (
        <>
            <PageTitle
                title="Аренда автобусов | Наш автопарк современных автобусов"
                description="Выбирайте автобус под ваши нужды: комфортные автобусы для экскурсий, корпоративов и частных поездок. Доступные цены, вместимость и надежные водители."
            />
