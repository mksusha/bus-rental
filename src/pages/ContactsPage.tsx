...
export default function ContactsPage() {
    ...
    return (
        <>
            <PageTitle
                title="Свяжитесь с нами — Минский автобусный сервис"
                description="Все контакты компании: адрес, телефоны, e-mail и режим работы для заказа автобусов с водителем в Минске."
            />
