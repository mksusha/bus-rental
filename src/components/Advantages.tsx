...
const advantages = [
    {
        ...
        text: "За плечами наших водителей множество маршрутов, что гарантирует вам безопасность на дороге.",
    },
    {
        icon: Tag,
        title: "Экономия",
    ...
    },
    {
        ...
        text: "Поможем в выборе транспорта и составим маршрут.",
    },
    {
        icon: Clock,
        title: "Опыт работы 15 лет",
        text: "Наш опыт поможет вам осуществить поездку с максимальным комфортом.",
    },
    {
        icon: Phone,
        title: "Удобство аренды",
        text: "Принимаем заказы через сайт, телефон и e-mail.",
    },
];

export default function Advantages() {
    return (
        <section className="py-20  max-w-[1400px] m-auto bg-white flex justify-center">
                        ...
                        return (
                            ...
                            >
                                <div className="flex-1">
                                    <h3 className="text-xl md:text-2xl font-semibold mb-14 text-gray-900">
                                        {adv.title}
                                    </h3>
