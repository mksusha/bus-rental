...
export default function FleetPage() {
    ...
    return (
        <>
            <Header />
            <div className="p-8 max-w-[1400px] mb-5 mt-24 mx-auto">
                <div
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-12 mb-5 ">
                    {buses.map((bus) => {
                        ...
                        return (
                            ...
                            >
                                <img
                                    src={firstImage}
                                    alt={bus.name}
                                    className="w-full h-56 object-cover rounded-t-2xl" // убрали отступы, увеличили высоту
                                />
                                ...
                                <div className="p-6 flex flex-col gap-3">
                                    ...
                                    <div className="flex items-center gap-4 text-gray-700">
                                        ...
                                        <div className="flex items-center gap-1 text-sm md:text-base">
                                            <img src="/time1.svg" alt="Время" className="w-6 h-6"/>
                                            <span>&gt; {bus.min_time} ч</span>
                                        </div>

                                        {/* Места */}
                                        <div className="flex items-center gap-1 text-sm md:text-base">
                                            <img src="/seat1.svg" alt="Места" className="w-6 h-6"/>
                                            <span> {bus.seats} мест</span>
                                        </div>

                                        {/* Цена */}
                                        <div className="flex items-center gap-1 text-sm md:text-base">
                                            <img src="/money.svg" alt="Цена" className="w-6 h-6"/>
